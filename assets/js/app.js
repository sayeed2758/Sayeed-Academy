(() => {
"use strict";
const KEY={catalog:"sa_v4_catalog",prefs:"sa_v4_prefs",favorites:"sa_v4_favorites",history:"sa_v4_history",blobs:"sa_v4_audio_blobs"};
...
function exportBackup(){const data={format:"sayeed-academy-backup",version:"4.0.0",createdAt:new Date().toISOString(),catalog,prefs:getPrefs(),favorites:favs(),history:hist()};download("sayeed-academy-backup.json",JSON.stringify(data,null,2),"application/json");toast("Backup downloaded")}
